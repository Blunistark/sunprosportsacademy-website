...
export const mockAppointments: Appointment[] = [
    { id: 'apt-001', clientName: 'Meera Reddy', clientEmail: 'meera@email.com', clientPhone: '+91 98765 43210', date: '2026-03-17', time: '10:00 AM', service: 'Balayage', stylist: 'Ananya', status: 'confirmed', branch: 'Bengaluru', createdAt: '2026-03-15T10:00:00Z' },
    { id: 'apt-002', clientName: 'Ravi Kumar', clientEmail: 'ravi@email.com', date: '2026-03-17', time: '11:00 AM', service: 'Classic & Creative Cuts', stylist: 'Vikram', status: 'confirmed', branch: 'Bengaluru', createdAt: '2026-03-15T11:00:00Z' },
    { id: 'apt-003', clientName: 'Priya Sharma', clientEmail: 'priya@email.com', clientPhone: '+91 87654 32109', date: '2026-03-17', time: '2:00 PM', service: 'Korean Glass Skin Facial', stylist: 'Ananya', status: 'pending', branch: 'Bengaluru', createdAt: '2026-03-16T09:00:00Z' },
    { id: 'apt-004', clientName: 'Arjun Desai', clientEmail: 'arjun@email.com', date: '2026-03-17', time: '3:00 PM', service: 'Beard Grooming', status: 'pending', branch: 'Kalaburagi', createdAt: '2026-03-16T12:00:00Z' },
    { id: 'apt-005', clientName: 'Sneha Patil', clientEmail: 'sneha@email.com', date: '2026-03-18', time: '10:00 AM', service: 'Luxury Bridal Makeover', stylist: 'Ananya', status: 'confirmed', branch: 'Bengaluru', notes: 'Wedding on March 20', createdAt: '2026-03-14T16:00:00Z' },
    { id: 'apt-006', clientName: 'Karthik Nair', clientEmail: 'karthik@email.com', date: '2026-03-18', time: '12:00 PM', service: 'Keratin & Smoothing', stylist: 'Vikram', status: 'pending', branch: 'Bengaluru', createdAt: '2026-03-16T14:00:00Z' },
    { id: 'apt-007', clientName: 'Anita Joshi', clientEmail: 'anita@email.com', date: '2026-03-16', time: '11:00 AM', service: 'Glass Skin Facials', stylist: 'Ananya', status: 'completed', branch: 'Kalaburagi', createdAt: '2026-03-14T09:00:00Z' },
    { id: 'apt-008', clientName: 'Deepak Verma', clientEmail: 'deepak@email.com', date: '2026-03-16', time: '4:00 PM', service: 'Hair Color Studio', status: 'cancelled', notes: 'Client rescheduled', branch: 'Bengaluru', createdAt: '2026-03-13T11:00:00Z' },
]
